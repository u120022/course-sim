...
const CourseTableRow: Component<{
  ...
  return (
    <tr class={has() ? "border-b bg-slate-100" : "border-b"}>
      ...
      <td
        ...
        tabindex={0}
      >
        <HiOutlinePlusCircle class="inline" color="#444444" />
        {course().name}
      </td>
  ...
  return (
    ...
    >
      ...
      <div class="mb-4 text-center">
        <span class="mx-2 font-bold">タグ</span>
      ...
      {/* highlight */}
      <div class="mb-4 text-center">
        <span class="mx-2 font-bold">ハイライト</span>
        <select
